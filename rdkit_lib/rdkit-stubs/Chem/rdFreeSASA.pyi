...
def CalcSASA(mol: Mol, radii: typing.Any, confIdx: int = -1, query: Atom = None, opts: SASAOpts = ...) -> float:
    """
        ...
        C++ signature :
            double CalcSASA(class RDKit::ROMol,class boost::python::api::object [,int=-1 [,class RDKit::Atom const * __ptr64=None [,struct FreeSASA::SASAOpts=<rdkit.Chem.rdFreeSASA.SASAOpts object at 0x000002B4D4EBEA40>]]])
    """
...
def classifyAtoms(mol: Mol, options: SASAOpts = ...) -> typing.Any:
    """
        ...
        C++ signature :
            class boost::python::api::object classifyAtoms(class RDKit::ROMol {lvalue} [,struct FreeSASA::SASAOpts=<rdkit.Chem.rdFreeSASA.SASAOpts object at 0x000002B4D4EBE9D0>])
    """
